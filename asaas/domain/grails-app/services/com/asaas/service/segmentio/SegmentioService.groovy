...
/**
 * Classe replicada do plugin [segmentio:1.0.7.5](https://github.com/agorapulse/grails-segment/blob/grails2/grails-app/services/grails/plugin/segmentio/SegmentioService.groovy)
 */
